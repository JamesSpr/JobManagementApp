...
const EstimateModule = ({ estimates, jobId, updateRequired, setUpdateRequired, users, bills, setBills, client, myobSync }) => {
            ...
            <Box sx={{width: '100%', borderBottom: 1, borderColor: 'divider' }}>
                ...
                <>
                    ...
                    <TabPanel key={0} value={value} index={0}>
                        {estimateData ? <EstimateOptionsOverview users={users} jobId={jobId} updateRequired={updateRequired} 
                                            setUpdateRequired={setUpdateRequired} bills={bills} setBills={setBills}
                                            contractors={contractors} client={client} myobSync={myobSync}/> : <p>Loading...</p> }
                    </TabPanel>
