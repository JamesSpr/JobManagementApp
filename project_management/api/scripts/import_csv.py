...
#                 job_id = job,
#                 name = tmp_data['PO #'].to_numpy().tolist()[row] if tmp_data['Quote #'].to_numpy().tolist()[row] == "" else tmp_data['Quote #'].to_numpy().tolist()[row],
...
#                 description = tmp_data['PO #'].to_numpy().tolist()[row],
#                 markup = 0,
#                 gross = amount,
#             )
